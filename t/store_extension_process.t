...
my $extension_text = 'has_substrate(GeneDB_Spombe:SPBC1105.11c),exists_during(GO:0034763),requires_feature(Pfam:PF00564)';
...
is ($new_term_prop_2->value, 'SPBC1105.11c');
